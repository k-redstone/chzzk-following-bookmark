    ...
    <CommonModal handleModalClose={handleModalClose}>
      <div className="dark:bg-foreground flex w-[32rem] flex-col gap-y-6 rounded-xl bg-white px-6 py-4 text-sm">
        <div className="flex justify-center">
          <h1
            className={`text-base font-extrabold ${payload?.variant === 'success' ? `dark:text-bg-chzzk-04 text-bg-chzzk-light-01` : 'text-warn-light dark:text-content-card-1000000'}`}
          >
